...
public class CardFieldView extends GridPane implements ViewObserver {
    final public static DataFormat ROBOT_RALLY_CARD = new DataFormat("games/roborally/cards");
    ...
    // Update the view when the card field changes
        ...
        public void handle(MouseEvent event) {
            ...
            if (t instanceof CardFieldView) {
                ...
                if (cardField != null &&
                    ...
                    content.put(ROBOT_RALLY_CARD, cardFieldRepresentation(cardField));
        ...
        public void handle(DragEvent event) {
            ...
            if (t instanceof CardFieldView) {
                ...
                if (cardField != null &&
                        ...
                        cardField.player != null &&
                        cardField.player.getBoard() != null) {
                    if (event.getDragboard().hasContent(ROBOT_RALLY_CARD)) {
            ...
            if (t instanceof CardFieldView) {
                ...
                if (cardField != null &&
                    ...
                    if (event.getGestureSource() != target &&
                            event.getDragboard().hasContent(ROBOT_RALLY_CARD)) {
        ...
        public void handle(DragEvent event) {
            ...
            if (t instanceof CardFieldView) {
                ...
                if (cardField != null &&
                        ...
                        cardField.player.getBoard() != null) {
                    if (event.getGestureSource() != target &&
                            db.hasContent(ROBOT_RALLY_CARD)) {
                        Object object = db.getContent(ROBOT_RALLY_CARD);
